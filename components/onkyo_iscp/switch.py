...
OnkyoReEqSwitch = onkyo_iscp_ns.class_("OnkyoReEqSwitch", switch.Switch,)
OnkyoMusicOptimizerSwitch = onkyo_iscp_ns.class_("OnkyoMusicOptimizerSwitch", switch.Switch,)
...
CONFIG_SCHEMA = cv.Schema(
    {
        ...
        cv.Optional(CONF_RE_EQ): switch.switch_schema(OnkyoReEqSwitch, icon="mdi:movie-filter",),
        cv.Optional(CONF_MUSIC_OPTIMIZER): switch.switch_schema(OnkyoMusicOptimizerSwitch,  icon="mdi:music-note-plus",),
    }
)
